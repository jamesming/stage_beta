...
$AddItemString = "Insert Into tblhomepage Values('', '$_POST[CarouselName]', '$Hero', '$Side', '$Premier', '$Day','$Tonight','$_POST[CarouselShowPageLink]','','$_POST[CarouselVideoLink]','$_POST[CarouselPremierDate]','$_POST[CarouselPremierTime]',
'$_POST[CarouselWeeklyDay]','$_POST[CarouselWeeklyTime]',0,0);";
$AddItem = mysql_query($AddItemString);	
}
else {
$AddItemString = "Insert Into tblhomepage Values('', '$_POST[CarouselName]', '$Hero', '$Side', '$Premier', '$Day','$Tonight','$_POST[CarouselShowPageLink]','$_POST[CarouselFacebookLink]','$_POST[CarouselVideoLink]','$_POST[CarouselPremierDate]','$_POST[CarouselPremierTime]',
'$_POST[CarouselWeeklyDay]','$_POST[CarouselWeeklyTime]',0,0);";
$AddItem = mysql_query($AddItemString);	
}
?>
<table border="0" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#999999">
    <td align="center"><font color="green" size="1"><strong><font size="2">Your new Homepage Carousel item has been added to the database!</font> </strong></font></td>
    </tr>    
    </table>
<?php
}
...
<table border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
    <td>
    <form action="AddCarouselItem.php" method="post">    
...
?>    
        ...
        <tr>
    <td></td>
    <td align="right"><input  type="submit" value="Add Carousel Item" /></td>
    </tr>
...
?>		    
    ...
    <tr>
    <td align="left"><font color="black"><strong>&nbsp;Item Name&nbsp;&nbsp;</strong></font></td>
    <td align="left"><input name="CarouselName" type="text" /></td>
    </tr>
    ...
    <tr>
    <td align="left"><font color="black"><strong>&nbsp;Show Page Link&nbsp;&nbsp;</strong></font></td>
    <td align="left"><input name="CarouselShowPageLink" type="text" /></td>
    </tr>
    
    <tr>
    <td align="left"><font color="black"><strong>&nbsp;Facebook Link&nbsp;&nbsp;</strong></font></td>
    <td align="left"><input name="CarouselFacebookLink" type="text" /></td>
    </tr>
    
    <tr>
    <td align="left"><font color="black"><strong>&nbsp;Video Link&nbsp;&nbsp;</strong></font></td>
    <td align="left"><input name="CarouselVideoLink" type="text" /></td>
    </tr>    

    <tr>
    <td align="left"><font color="black"><strong>&nbsp;Premier Date&nbsp;&nbsp;</strong></font></td>
    <td align="left"><input name="CarouselPremierDate" id="CarouselPremierDate" type="text" /></td>
    </tr>
...
<option>Choose...</option>
<?php  
  while ($Time1 = mysql_fetch_assoc($GetTime1)) { 
  echo  "<option value=\"".$Time1['Time']."\">".$Time1['Time']."</option>";
  }
?>  
</select>
    </td>
...
<option>Choose...</option>
<?php  
  while ($Days= mysql_fetch_assoc($GetDays)) { 
  echo  "<option value=\"".$Days['Day']."\">".$Days['Day']."</option>";
  }
?>  
</select>    
</td>
...
<option>Choose...</option>
<?php  
  while ($Time1 = mysql_fetch_assoc($GetTime2)) { 
  echo  "<option value=\"".$Time1['Time']."\">".$Time1['Time']."</option>";
  }
?>  
</select>
