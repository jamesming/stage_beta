...
<style>
#my-global-wrap {
	background: url('images/MLLV-Microsite-reveal-bkg.jpg') no-repeat scroll 50% 0 transparent;
}
...
<?
					require_once('ml4castreveal.php');
?>					
					<div id="fb-root">&nbsp;</div>
					...
					<div style="width: 100%; float: left; background-color: #FFFFFF;">
						<div style="float: left; width: 500px;"><fb:comments width="500" num_posts="10" href="www.mynuvotv.com/model-latina-vegas-cast"></fb:comments></div>
					</div>		
				</div>
