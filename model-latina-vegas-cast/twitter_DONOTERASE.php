...
<style>
#my-global-wrap {
	background: url('images/MLLV-Microsite-twitter-bkg.jpg') no-repeat scroll 50% 0 transparent;
}
	...
	<div id="my-global-wrap"  style="">
		<div id="my-container" style="width: 1000px;">
			...
			<div class="footer_block" style="width: 100%; float: left; padding-top: 3px; margin-bottom: 100px;">
				<div class="left_block" style="width: 818px; float: left; padding-top: 3px; margin-bottom: 50px;">
					<div class="twitter" style="float: left; width: 811px;" >
					...
					<div style="float: left; margin-top: 29px; margin-left: 5px;">
						<a href="/misc/referafriend.php"><img src="images/T-SHIRT-PROMO.jpg" width="505" height="272" /></a>
					</div>
				</div>
				...
				<div class="social_links" style="float: left; background: url('images/footer-box.png') no-repeat scroll 0% 0pt #000000;  margin-left: 2px; width: 178px; height: 267px; margin-top: 5px;" >
					...
					<div style="float: left; margin-top: 20px;"><img src="images/banner.jpg" /></div>
				</div>
			</div>
