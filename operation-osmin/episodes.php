...
<div id="middle_block" style="float: left; height: 940px;">
	<div style="float: left; width: 733px;">
		...
		<div class="slider-wrap" style="height: 439px;">
			<div style="height: 400px; background: url('images/centerpiece/video-frame-v2.png') no-repeat scroll 0% 0 transparent; padding-top: 0px; padding-left: 0px;">
				<!-- Start of Brightcove Player -->
				<object id="myExperience" class="BrightcoveExperience">
				  <param name="bgcolor" value="#FFFFFF" />
				  <param name="width" value="630" />
				  <param name="height" value="430" />
				  <param name="playerID" value="942843431001" />
				  <param name="playerKey" value="AQ~~,AAAAADEdZAY~,VHcBVNPqDVvbCcnW6i5lHtNSJpyhxHMS" />
		...
		<div style="width: 850px; font-size: 15px; color: rgb(0, 0, 0); float: left; padding-left: 10px;">	
			<div style="float: left; font-size: 21px; font-weight: bold; height: 32px; width: 600px; padding-top: 5px;">
				JOE: OUTTA CONTROL OSMIN
			</div>
			<div class="next_ep_container" style="float: left; width: 580px; padding-top: 10px;" >
				Osmin meets his first recruit, Joe, a health food store owner who has had trouble practicing what he preaches.  Osmin is unleashed and Joe learns that for all that weight GAIN there is going to be some exercise PAIN. There's plenty of blood, sweat, and tears as Osmin pushes Joe over the edge (literally).  Will Joe's sweet tooth be his downfall? One thing is for sure:  Joe will never look at a cupcake the same way again!
			</div>
			<div class="next_ep_container" style="float: left; width: 540px; padding-top: 10px;" >
			</div>
			<div class="next_ep_container" style="float: left; width: 450px; padding-top: 20px;" >
				<b>Will Joe survive?</b>
			</div>
			<div style="float: left; font-size: 17px; font-weight: bold; height: 32px; width: 600px; padding-top: 20px;">
				<span style="color: gray;">EP 1: JOE</span> | <a style="font-size: 17px;" href="episodes-biankha.php">EP 2: BIANKHA</a> | <a style="font-size: 17px;" href="episodes-willy.php">EP 3: WILLY</a> | <a style="font-size: 17px;" href="episodes-khalia.php">EP 4: KHALIA</a>
				<br />
				<div style="float: left; margin-top: 10px;">
					<a style="font-size: 17px;" href="episodes-adriana.php">EP 5: ADRIANA</a> | <a style="font-size: 17px;" href="episodes-drew.php">EP 6: DREW</a> | <a style="font-size: 17px;" href="episodes-domina.php">EP 7: DOMINA</a> | <a style="font-size: 17px;" href="episodes-louisa.php">EP 8: LOUISA</a>
				</div>
				<div style="float: left; margin-top: 10px;">
					<a style="font-size: 17px;" href="episodes-christian.php">EP 9: CHRISTIAN</a> | <a style="font-size: 17px;" href="episodes-adam.php">EP 10: ADAM</a>
				</div>
			</div>
		</div>	
