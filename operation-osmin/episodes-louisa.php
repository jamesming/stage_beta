	...
	<div style="float: left; width: 733px;">
		...
		<div class="slider-wrap" style="height: 439px;">
			<div style="height: 400px; background: url('images/centerpiece/video-frame-v2.png') no-repeat scroll 0% 0 transparent; padding-top: 0px; padding-left: 0px;">
				...
				<object id="myExperience" class="BrightcoveExperience">
				  ...
				  <param name="playerID" value="1124400114001" />
				  <param name="playerKey" value="AQ~~,AAAAADEdZAY~,VHcBVNPqDVteFootqpey4o0H1mDKBxto" />
		...
		<div style="width: 850px; font-size: 15px; color: rgb(0, 0, 0); float: left; padding-left: 10px;">	
			<div style="float: left; font-size: 21px; font-weight: bold; height: 32px; width: 600px; padding-top: 5px;">
				LOUISA: PRETTY IS AS PRETTY EATS!
			</div>
			<div class="next_ep_container" style="float: left; width: 580px; padding-top: 10px;" >
				As a single mom, social worker and college professor, Louisa doesn't have much time for herself.  She is always told that she's beautiful.  But the compliments stop there.  Now, this buxom beauty wants the body to match!    A 30 day crash course with Osmin may be just what she needs to get back on track...and into her favorite denim cat suit.  				
			</div>	
			...
			<div class="next_ep_container" style="float: left; width: 450px; padding-top: 20px;" >
				<b>Mission: Fit into her cat suit.</b>
			</div>
			<div style="float: left; font-size: 17px; font-weight: bold; height: 32px; width: 600px; padding-top: 20px;">
				...
				<div style="float: left; margin-top: 10px;">
					<a style="font-size: 17px;" href="episodes-adriana.php">EP 5: ADRIANA</a> | <a style="font-size: 17px;" href="episodes-drew.php">EP 6: DREW</a> | <a style="font-size: 17px;" href="episodes-domina.php">EP 7: DOMINA</a> | <span style="color: gray;">EP 8: LOUISA</span>
				</div>
				<div style="float: left; margin-top: 10px;">
