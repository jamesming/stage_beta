...
$wed = strtotime("August 17, 2011 8:00am");
		...
		<div style="width: 850px; font-size: 15px; color: rgb(0, 0, 0); float: left; padding-left: 10px;">	
			<div class="next_ep_container" style="float: left; width: 450px;" >
				<div style="float: left; font-size: 27px; font-weight: bold; height: 32px; width: 600px; padding-top: 25px;">
					GET SCARED FIT EVERY TUESDAY 9/8c
				</div>
...
?>	
					<div style="float: left; padding-top: 8px;">
						<a href="therecruits.php?recruit=8"><img src="images/small-LOUISA.png" /></a>
					</div>
					<div style="float: left; padding-left: 15px; font-weight: bold; padding-top: 5px;">
						<a style="color:#000000;" href="therecruits.php?recruit=8">LOUISA</a>
					</div>
...
?>
					<div style="float: left; padding-top: 8px;">
						<a href="therecruits.php?recruit=7"><img src="images/small-DOMINA.png" /></a>
					</div>
					<div style="float: left; padding-left: 15px; font-weight: bold; padding-top: 5px;">
						<a style="color:#000000;" href="therecruits.php?recruit=7">DOMINA</a>
					</div>
					<div style="float: left; padding-left: 15px; width: 250px; font-size: 13px;">
						This Italian Stallion desperately wants to trim her rear end and be in better shape than her mom, but it's her way or the highway. Osmin's not having it! Will this difficult diva be the first to fall off, or will Osmin show her some mercy? 
					</div>				
<?
	}
?>					
