	...
	<div style="float: left; width: 733px;">
		...
		<div class="slider-wrap" style="height: 439px;">
			<div style="height: 400px; background: url('images/centerpiece/video-frame-v2.png') no-repeat scroll 0% 0 transparent; padding-top: 0px; padding-left: 0px;">
				...
				<object id="myExperience" class="BrightcoveExperience">
				  ...
				  <param name="playerID" value="1135537439001" />
				  <param name="playerKey" value="AQ~~,AAAAADEdZAY~,VHcBVNPqDVtG2ZGbiGmiqJT-z9m7q_dx" />
		...
		<div style="width: 850px; font-size: 15px; color: rgb(0, 0, 0); float: left; padding-left: 10px;">	
			<div style="float: left; font-size: 21px; font-weight: bold; height: 32px; width: 600px; padding-top: 5px;">
				ADAM: THE PROFESSIONAL EATER
			</div>
			<div class="next_ep_container" style="float: left; width: 580px; padding-top: 10px;" >
				A personal chef to professional athletes, Adam loves to eat and his body shows it!  Though he sees the irony of cooking healthy food for amazingly fit athletes, he justifies his weight by his belief that you should "never trust a skinny chef."  Will Osmin's wild workouts&mdash;and his "fish, salad, water" mantra&mdash;whip this food lover into shape before his wedding? 
			</div>	
			...
			<div class="next_ep_container" style="float: left; width: 450px; padding-top: 20px;" >
				<b>Mission: Go from fat to fit fianc&eacute;.</b>
			</div>
			<div style="float: left; font-size: 17px; font-weight: bold; height: 32px; width: 600px; padding-top: 20px;">
				<a style="font-size: 17px;" href="episodes.php">EP 1: JOE</a> | <a style="font-size: 17px;" href="episodes-biankha.php">EP 2: BIANKHA</a> | <a style="font-size: 17px;" href="episodes-willy.php">EP 3: WILLY</a> | <a style="font-size: 17px;" href="episodes-khalia.php">EP 4: KHALIA</a>
 				<br />
				...
				<div style="float: left; margin-top: 10px;">
					<a style="font-size: 17px;" href="episodes-christian.php">EP 9: CHRISTIAN</a> | <span style="color: gray;">EP 10: ADAM</span>
				</div>
			</div>
		</div>	
