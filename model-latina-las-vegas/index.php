...
?>
			var text= '<div style="width: 640px; margin-top: -4px; margin-left: 112px; color: #FFFFFF; font-weight: bold; float: left;"><div style="padding-top: 20px ">Five Sexy Female Boxers<br /><br />Fists were seriously flying when the ladies tested their skills in the boxing ring. Not only did they have to be ring girls for a day a skill -we learned, looks much easier than it is- but they had to slip on punching gloves too! Natasha surprised everybody when she tried to knock out Sarah for supposedly being fake. Speaking of ladies who like to punch, here are five professional female boxers with looks and skill that can kill. </div></div>';
<?
		}
?>		
			$('.center_content').fadeOut(1000, function() {
