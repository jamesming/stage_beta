...
$tue = strtotime("August 9, 2011 8:00am");
	
$wed = strtotime("August 10, 2011 8:00am");

$thu = strtotime("August 11, 2011 8:00am");

if($_GET[tue]) {
	$now = strtotime("August 9, 2011 8:01am");
}
...
EOTHEME;
	...
	<ul class="unstyled controls">
		...
		<li>
			<div class="offset" style="background:transparent url(/assets/images/heroes/home/txt-ML_NYC2.png) no-repeat 0 0; left:-4px; top:282px; width:669px; height:161px;">
				<a href="http://www.facebook.com/ModelLatina" style="left:317px; top:84px; width:218px; height:73px; z-index:2;">facebook</a>
