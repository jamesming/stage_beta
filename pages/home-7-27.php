...
$tue = strtotime("July 26, 2011 8:00am");
	
$wed = strtotime("July 27, 2011 8:00am");

$thu = strtotime("July 28, 2011 8:00am");

if($_GET[tue]) {
	$now = strtotime("July 26, 2011 8:01am");
}

if($_GET[wed]) {
	$now = strtotime("July 27, 2011 8:01am");
}

if($_GET[thu]) {
	$now = strtotime("July 28, 2011 8:01am");
}
...
$page->template = "standard";
	...
	$page->components["theme"]  = <<<EOTHEME
		...
		<div style="background:transparent url(/assets/images/heroes/home/_bg_Adrenalina.jpg) no-repeat 0 0;"></div>
EOTHEME;
	...
	<ul class="unstyled tabs">
		...
		<li class="tab-4" style="background-image: url(/assets/images/heroes/home/tab-Adrenalina2.png);"></li>
	</ul>
	<ul class="unstyled controls">
		<li>
		...
		<li>
			<div class="offset" style="background:transparent url(/assets/images/heroes/home/txt-Adrenalina.png) no-repeat 0 0; left:230px; top:282px; width:669px; height:161px;">
				<a href="http://www.facebook.com/nuvoTV" style="left:92px; top:91px; width:218px; height:73px; z-index:2;">facebook</a>
				<a href="/series/adrenalina/" style="left:511px; top:83px; width:154px; height:74px; z-index:1;">video</a>
				<a class="full-link" href="/series/adrenalina/">base link</a>
			</div>
			<a class="full-link" href="/series/adrenalina/">base link</a>
		</li>
