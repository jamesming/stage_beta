...
EOHERO;
	...
	$schedule = getSchedule("model-latina-las-vegas");
	...
	<div class="main">
		<div class="featured white-box block">
			...
			<div class="copy">
				...
				<p>Duis aute irure dolor in reprehenderit in voluptate velit esse. <a href="/series/model-latina-las-vegas/features" class="no-break">Read More +</a></p>
			</div>
		</div>
		...
		<div class="cast padded-box block">
			...
			<a class="sub-page-more" href="/series/model-latina-las-vegas/cast">See the entire cast +</a>
		</div>
	</div>
	<div class="sidebar-right">
		<div class="ad ad-box block"></div>
		<div class="social block">
			<h2>Find model-latina-las-vegas on</h2>
			<ul class="unstyled">
		...
		<div class="photos block">
			...
			<a class="sub-page-more" href="/series/model-latina-las-vegas/photos">See all photos +</a>
		</div>
	</div>
EOCONTENT;
