...
$fri = strtotime("July 29, 2011 8:00am");
	
$sat = strtotime("July 30, 2011 8:00am");

$sun = strtotime("July 31, 2011 8:00am");

$mon = strtotime("August 1, 2011 8:00am");

if($_GET[fri]) {
	$now = strtotime("July 29, 2011 8:01am");
}

if($_GET[sat]) {
	$now = strtotime("July 30, 2011 8:01am");
}

if($_GET[sun]) {
	$now = strtotime("July 31, 2011 8:01am");
}

if($_GET[mon]) {
	$now = strtotime("August 1, 2011 8:01am");
}
...
$page->template = "standard";
	...
	$page->components["theme"]  = <<<EOTHEME
		...
		<div style="background:transparent url(/assets/images/heroes/home/_bg_Osmin3.jpg) no-repeat 0 0;"></div>
...
EOTHEME;
	...
	<ul class="unstyled tabs">
		...
		<li class="tab-1" style="background-image: url(/assets/images/heroes/home/tab-OSMIN-v3.png);"></li>
	...
	<ul class="unstyled controls">
		<li>
			<div class="offset" style="background:transparent url(/assets/images/heroes/home/txt_Osmin6.png) no-repeat 0 0; left:-8px; top:275px; width:670px; height:168px;">
...
EOTHEME;
	...
	<ul class="unstyled controls">
		...
		<li>
			<div class="offset" style="background:transparent url(/assets/images/heroes/home/txt_Latino101_tonight.png) no-repeat 0 0; left:75px; top:275px; width:663px; height:168px;">
