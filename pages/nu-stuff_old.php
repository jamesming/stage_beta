	...
	if($_GET[ringtones] == 1 OR !$_GET[wallpapers]) {
		...
		<div class="main">
			<div class="white-box block">
				<h2>Nu Ringtones</h2>
				<p>Need some motivation to kick-start your workout routine? Download some hilarious ringtones from Operation Osmin's most psychotic trainer himself. (Warning: These may cause extreme exercising.) Just click "Download" and save to your desktop or music library. Having problems downloading ringtones? <a href="http://www.ehow.com/how_2076605_install-ringtones.html" target="_blank">Click here</a> for step-by-step instructions. </p>
				...
				<ul class="unstyled ringtones">
					...
					<li class="col2">
						<div style="min-height: 40px;">
							<img src="/assets/images/ringtone-icon.png" style="float: left; padding-right: 10px; margin-top: 3px;" />
							<h3 style="font-size: 15px; margin-bottom: 3px;">2.	25 Puchups</h3>
