...
$sat = strtotime("July 23, 2011 8:00am");
	
$sun = strtotime("July 24, 2011 8:00am");

$mon = strtotime("July 25, 2011 8:00am");

if($_GET[sat]) {
	$now = strtotime("July 23, 2011 8:01am");
}

if($_GET[sun]) {
	$now = strtotime("July 24, 2011 8:01am");
}

if($_GET[mon]) {
	$now = strtotime("July 25, 2011 8:01am");
}
...
EOTHEME;
	...
	<ul class="unstyled tabs">
		...
		<li class="tab-3" style="background-image: url(/assets/images/heroes/home/tab-ML_Vegas.png);"></li>
		<li class="tab-4" style="background-image: url(/assets/images/heroes/home/tab-Latino101.png);"></li>
	</ul>
	<ul class="unstyled controls">
		...
		<li>
			<div class="offset" style="background:transparent url(/assets/images/heroes/home/txt_Latino101_tonight.png) no-repeat 0 0; width: 669px; height: 161px; left: 100px; top: 305px;">
				<a href="http://www.facebook.com/nuvoTV" style="left:200px; top:91px; width:218px; height:73px; z-index:2;">facebook</a>
				<a href="/series/latino-101-s2/" style="left:511px; top:83px; width:154px; height:74px; z-index:1;">video</a>
	...
	<div class="b-spot block">
		<div class="featured white-box block">
			<ul class="unstyled featured-list">
				...
				<li>
					<a href="/model-latina-vegas-cast/" class="no-break"><img class="bordered media" src="/assets/images/spotlight/ML4-Spotlight_w3_238x218.jpg" /></a>
					<div class="copy">
						<h2>Nu Spotlight</h2>
			...
			<ul class="inline thumbs">	
				...
				<li style="background-image:url(/assets/images/spotlight/MLLV_w3_thmb2.png);"><a href="#" title="ML4 Week 3 Reveal">Link2</a></li>
...
EOTHEME;
	...
	<ul class="unstyled controls">
		<li>
			<div class="offset" style="background:transparent url(/assets/images/heroes/home/txt_Osmin4.png) no-repeat 0 0; left:-8px; top:275px; width:670px; height:168px;">
				<a href="http://www.facebook.com/OperationOsmin" style="height: 74px; z-index: 2; top: 93px; width: 203px; left: 326px;">facebook</a>
				<a class="full-link" href="/operation-osmin/">base link</a>			
			</div>
			<a class="full-link" href="/operation-osmin/">base link</a>			
...
EOTHEME;
	...
	<ul class="unstyled controls">
		...
		<li>
			<div class="offset" style="background:transparent url(/assets/images/heroes/home/txt-GirlFight-v3.png) no-repeat 0 0; width: 669px; height: 161px; left: 300px; top: 305px;">
				<a href="http://www.facebook.com/nuvoTV" style="left:200px; top:91px; width:218px; height:73px; z-index:2;">facebook</a>
				<a href="/movies" style="left:511px; top:83px; width:154px; height:74px; z-index:1;">video</a>
				<a class="full-link" href="/movies">base link</a>
			</div>
