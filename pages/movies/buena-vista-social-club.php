...
EOTHEME;
	...
	<div class="controls" style="background: transparent url(/assets/images/heroes/movies/txt_buenaVistSocialClub.png) no-repeat 0 0; left:0px; top:150px; width:761px; height:64px;">
	</div>
EOHERO;


	$schedule = getSchedule("buena-vista-social-club");
