...
<link rel="shortcut icon" href="/favicon.ico" />
 ...
 <link rel="image_src" href="http://www.mynuvotv.com/images/ml_fb_icon.jpg" />
...
<style>
#my-global-wrap {
	background: url('images/MLLV-Microsite-tshirt-bkgv3.jpg') no-repeat scroll 50% 0 transparent;
}
		...
		<div id="my-container" style="width: 1000px;">
			...
			<div id="middle_block">
				<div class="middle_content" style="float: left; height: 660px; width: 836px;">
					...
					<div id="center_content" class="center_content" style="float: left; position: relative; overflow: hidden; height: 280px; width: 510px; top: 153px; left: 268px;">
						<object id="myExperience921409540001" class="BrightcoveExperience">
						  <param name="wmode" value="transparent" />
						  <param name="width" value="510" />
						  <param name="height" value="380" />
						  <param name="playerID" value="1090428688001" />
						  <param name="playerKey" value="AQ~~,AAAAADEdZAY~,VHcBVNPqDVuwGytdG043jMG7PXsmnWag" />
					...
					<div style="height: 103px; width: 100%; float: left;">
						<div id="visit" style="height: 33px; width: 179px; float: left; padding-top: 0px; margin-left: 200px;">
							<a href="/model-latina-las-vegas" ><img id="visit" name="visit" src="images/VISITmllv-bttn.png" style="cursor: pointer; position: relative; z-index: 10;" /></a>
						</div>
					</div>
					</div>
			...
			<div class="footer_block" style="width: 100%; float: left; padding-top: 3px; margin-bottom: 100px;">
				<div class="left_block" style="width: 310px; float: left; padding-top: 3px; margin-bottom: 50px;">
					<div id="facebook_like_box" style="float: left; margin-top: 3px;">
						<iframe scrolling="no" frameborder="0" allowtransparency="true" style="border: medium none; overflow: hidden; width: 302px; height: 660px; background-color: #FFFFFF;" src="http://www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2FModelLatina&amp;width=302&amp;colorscheme=light&amp;show_faces=true&amp;stream=true&amp;header=true&amp;height=660"></iframe>
					</div>	
					<div class="my-ad250x300" style="float: left; background: url('images/square-banner-ad.png') no-repeat scroll 0% 0 transparent; border: 1px solid white; padding-top: 15px; width: 301px; height: 251px; margin-top: 31px;" >
						<script language="javascript">
						   printAd(3,3)
						</script>
					</div>
				</div>
				<div class="bottom_middle" style="width: 503px; float: left; margin-left: 7px;">
<?
					require_once('referafriend_form.php');
?>						
				</div>

				<div class="social_links" style="float: left; background: url('images/footer-box.png') no-repeat scroll 0% 0pt #000000;  margin-left: 2px; width: 178px; height: 267px; margin-top: 5px;" >
					...
					<div style="float: left; height: 133px; width: 178px; background-image: url(images/4_verizon-sponsor.png); margin-top: 60px;"></div>
				</div>
			</div>
